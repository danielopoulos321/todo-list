...
.modal-content {
  ...
  .close:focus {
    ...
    cursor: pointer;
  }`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,mCAAmC;IACnC,oBAAoB;AACxB;;AAEA;IACI,SAAS;IACT,UAAU;AACd;;AAEA;IACI,uCAAuC;IACvC,2BAA2B;IAC3B,0GAA0G;AAC9G;;AAEA;IACI,YAAY;IACZ,6BAA6B;IAC7B,gBAAgB;IAChB,mBAAmB;IACnB,iBAAiB;IACjB,oBAAoB;IACpB,cAAc;AAClB;;AAEA;IACI,4CAA4C;AAChD;;AAEA;IACI,aAAa;IACb,aAAa;IACb,8BAA8B;IAC9B,4BAA4B;AAChC;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,yCAAyC;IACzC,2CAA2C;IAC3C,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB;AACJ;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,YAAY;AAChB;;AAEA;IACI,UAAU;IACV,iCAAiC;IACjC,2CAA2C;AAC/C;;AAEA;IACI,uCAAuC;AAC3C;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,wCAAwC;AAC5C;;AAEA;IACI,WAAW;IACX,aAAa;IACb,sBAAsB;AAC1B;;AAEA;IACI,4CAA4C;AAChD;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;IACnB,WAAW;IACX,aAAa;IACb,WAAW;IACX,iCAAiC;IACjC,yCAAyC;IACzC,2CAA2C;AAC/C;;AAEA;IACI,aAAa;IACb,yBAAyB;IACzB,mBAAmB;AACvB;;AAEA;;;IAGI,YAAY;IACZ,kBAAkB;AACtB;;AAEA;;;IAGI,oBAAoB;AACxB;;AAEA;IACI,kBAAkB;AACtB;;AAEA,sBAAsB;AACtB;IACI,4BAA4B;AAChC;;AAEA;IACI,6BAA6B;AACjC;;AAEA;IACI,0BAA0B;AAC9B;;AAEA,WAAW;AACX;;;IAGI,aAAa;IACb,eAAe;IACf,UAAU;IACV,OAAO;IACP,MAAM;IACN,WAAW;IACX,YAAY;IACZ,cAAc;IACd,4BAA4B,EAAE,mBAAmB;IACjD,iCAAiC,EAAE,qBAAqB;AAC5D;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,yBAAyB;IACzB,gBAAgB,EAAE,kCAAkC;IACpD,aAAa;IACb,2CAA2C;IAC3C,iCAAiC;IACjC,YAAY,EAAE,oDAAoD;EACpE;;EAEA;IACE,aAAa;IACb,mBAAmB;IACnB,8BAA8B;EAChC;;EAEA;IACE,aAAa;IACb,eAAe;IACf,8BAA8B;EAChC;;EAEA;IACE,gBAAgB;IAChB,cAAc;IACd,WAAW;IACX,mBAAmB;IACnB,uBAAuB;IACvB,0CAA0C;EAC5C;;EAEA;IACE,YAAY;IACZ,qCAAqC;IACrC,uCAAuC;IACvC,gBAAgB;IAChB,mBAAmB;IACnB,gBAAgB;IAChB,cAAc;EAChB;;EAEA;IACE,qCAAqC;EACvC;EACA,qBAAqB;EACrB;IACE,WAAW;IACX,eAAe;IACf,iBAAiB;EACnB;;EAEA;;IAEE,YAAY;IACZ,qBAAqB;IACrB,eAAe;EACjB","sourcesContent":[":root {\n    --faded-bg: hsla(0, 0%, 100%, 0.65); \n    --card-radius: .75em;\n}\n\n*{\n    margin: 0;\n    padding: 0;\n}\n\nbody{\n    font-family: 'Trebuchet MS', sans-serif;\n    background: rgb(131,58,180);\n    background: linear-gradient(45deg, rgba(131,58,180,1) 0%, rgba(29,253,228,1) 50%, rgba(252,176,69,1) 100%);\n}\n\nbutton{\n    border: none;\n    background-color: transparent;\n    font-size: 1.2em;\n    border-radius: .5em;\n    margin-top: .25em;\n    margin-bottom: .25em;\n    padding: .25em;\n}\n\n.active{\n    background-color: rgba(156, 213, 251, 0.469);\n}\n\n.container{\n    height: 100vh;\n    display: grid;\n    grid-template-columns: 1fr 4fr;\n    grid-template-rows: 1fr 10fr;\n}\n\n#sidebar{\n    grid-column: 1/2;\n    grid-row: 1/3;\n    background-color: hsla(0, 0%, 100%, 0.65);\n    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    padding:1em\n}\n\n#header{\n    display: flex;\n    justify-content: space-between;\n    padding: 1em;\n}\n\n#newTask{\n    width: 7em;\n    background-color: var(--faded-bg);\n    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);\n}\n\n#newTask:hover {\n    background-color: hsla(0, 0%, 65%, 0.5);\n}\n\n#content{\n    grid-column: 2/3;\n    grid-row: 1/3;\n    background-color: hsla(0, 0%, 100%, 0.5);\n}\n\n#projects{\n    width: 100%;\n    display: flex;\n    flex-direction: column;\n}\n\n.project:hover{\n    background-color: rgba(156, 213, 251, 0.469);\n}\n\n.task{\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n    align-items: center;\n    margin: 1em;\n    padding: .5em;\n    width: auto;\n    border-radius: var(--card-radius);\n    background-color: hsla(0, 0%, 100%, 0.65);\n    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);\n}\n\n.rightSide{\n    display: flex;\n    justify-content: flex-end;\n    align-items: center;\n}\n\n.edit, \n.remove, \n.info {\n    height: 35px;\n    padding-left: .5em;\n}\n\n.edit:hover, \n.remove:hover, \n.info:hover {\n    filter: opacity(0.6);\n}\n\n.notes{\n    padding-right: 1em;\n}\n\n/* Border Priorities */\n.priority-low {\n    border-left: 8px solid green;\n}\n\n.priority-medium {\n    border-left: 8px solid yellow;\n}\n\n.priority-high {\n    border-left: 8px solid red;\n}\n\n/* Modals */\n#projectModal,\n#taskModal, \n#infoModal{\n    display: none;\n    position: fixed;\n    z-index: 1;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    overflow: auto;\n    background-color: rgb(0,0,0); /* Fallback color */\n    background-color: rgba(0,0,0,0.4); /* Black w/ opacity */\n}\n\n.modal-content {\n    display: flex;\n    flex-direction: column;\n    background-color: #fefefe;\n    margin: 10% auto; /* 15% from the top and centered */\n    padding: 15px;\n    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5);\n    border-radius: var(--card-radius);\n    width: 400px; /* Could be more or less, depending on screen size */\n  }\n\n  .form-head{\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n  }\n\n  .inputs{\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: space-between;\n  }\n\n  .item{\n    margin-top: .5em;\n    padding: .25em;\n    width: 100%;\n    border-radius: .5em;\n    border: 1px solid black;\n    box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.5);\n  }\n\n  .submit{\n    border: none;\n    background-color: rgba(29,253,228,.3);\n    box-shadow: 0px 0px 10px rgb(6, 49, 44);\n    font-size: 1.2em;\n    border-radius: .5em;\n    margin-top: .5em;\n    padding: .25em;\n  }\n  \n  .submit:hover {\n    background-color: rgba(29,253,228,.8);\n  }\n  /* The Close Button */\n  .close {\n    color: #aaa;\n    font-size: 28px;\n    font-weight: bold;\n  }\n  \n  .close:hover,\n  .close:focus {\n    color: black;\n    text-decoration: none;\n    cursor: pointer;\n  }"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _src_assets_delete_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../src/assets/delete.svg */ "./src/assets/delete.svg");
/* harmony import */ var _src_assets_edit_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../src/assets/edit.svg */ "./src/assets/edit.svg");
/* harmony import */ var _src_assets_info_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../src/assets/info.svg */ "./src/assets/info.svg");
...
function loadProjectTasks (projectName) {
    ...
    allTasks.forEach((task, index) => {
        ...
        date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(task.getDueDate()), 'MMM dd');
        notes.textContent = task.getDescription();
        newTask.classList.add(`priority-${task.getPriority()}`);

        const edit = new Image();
        edit.src = _src_assets_edit_svg__WEBPACK_IMPORTED_MODULE_2__;
        edit.classList.add('edit');
        edit.dataset.taskIndex = index;       

        const remove = new Image();
        remove.src = _src_assets_delete_svg__WEBPACK_IMPORTED_MODULE_1__;
        remove.classList.add('remove');
        remove.dataset.taskIndex = index;

        const info = new Image();
        info.src = _src_assets_info_svg__WEBPACK_IMPORTED_MODULE_3__;
...
module.exports = __webpack_require__.p + "b28700980249a56d3a0b.svg";
...
module.exports = __webpack_require__.p + "59b283cde6078521fc95.svg";
